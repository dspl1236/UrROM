...
- [docs/3B_MAF_hotfilm_notes.md](docs/3B_MAF_hotfilm_notes.md) — the G70 hot-wire (burn-off, limp behaviour), the Timer 1 pulse path and linearisation tables, what a hot-film swap needs and how to calibrate it on the road
