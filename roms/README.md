...
| `prj_stock_aan-aby_551aa_0202.bin` | 4A0907551AA (prjmod layout) | prj's AAN/ABY **base** (github.com/prj/m232, GPL-3.0): RS2 D02 firmware + the ABY/ADU/RS2 D02 calibration, but fuel and ign map 2 **re-gridded to a 10…240 load / 7400 rpm axis** (300 kPa-sensor shape), fuel +10…+28 raw at high load, map 2 −5…−13 raw in the boost region, map 4 −5.6 raw; maps 1/3/5/6/7 byte-identical to the real chips. Not AAN maps, not stock | — | `0x81D197CF` | ⚠ prj BASE tune |
...
| `3b_boost_404aa_3bar034.bin` | 3B boost chip `0xF50660DA` | Stock 3B boost re-encoded for the GM / 034 3-bar MAP sensor (`urrom.cli boost-sensor --to vmap300_034`): same kPa everywhere, duty tables untouched. For running the 3-bar sensor with otherwise stock chips | `0x4A9B1E46` | ⚠ EXPERIMENTAL — requires the 3-bar sensor fitted; the cluster boost gauge will read wrong; not yet driven |
...
| `3b_boost_404aa_3bar034_27C512.bin` | `tunes/404/3b_boost_404aa_3bar034.bin` | 8 | `0x4C3F14BD` |
